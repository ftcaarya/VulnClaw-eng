...
class KnowledgeRetriever:
    ...
    def _init_backend(self) -> None:
        ...
        if CHROMADB_AVAILABLE:
            try:
                ...
                if backend.has_data():
                    ...
                    self._status_detail = "ChromaDB semantic search enabled"
                    return
        ...
        try:
            ...
            self._status_detail = f"Keyword-search initialization failed: {exc}"
            return
        ...
        if keyword.has_data():
            ...
            if not CHROMADB_AVAILABLE:
                self._status_detail = (
                    ...
                    "downgraded to keyword search"
                )
            elif not self._status_detail:
                self._status_detail = "downgraded to keyword search"
        else:
            self._status = RetrieverStatus.DISABLED
