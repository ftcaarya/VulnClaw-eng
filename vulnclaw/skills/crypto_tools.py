...
@_register(
    "caesar_encode", "encode", "Caesar cipher encode (shift)", ["input"], {"shift": "Shift amount, default 3"}
)
...
@_register("auto_decode", "decode", "Auto-detect encoding type and decode (tries all common encodings)", ["input"])
